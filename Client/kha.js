...
WorkerKha.prototype = {
	...
	,onMessage: function(message) {
		...
		case "endFrame":
			...
			break;
		case "loadBlob":
			kha_Assets.loadBlobFromPath(data.file,function(blob) {
			...
			break;
		case "loadImage":
			kha_Assets.loadImageFromPath(data.file,false,function(image) {
			...
			break;
		case "loadSound":
			kha_Assets.loadSoundFromPath(data.file,function(sound) {
				if(_gthis.worker != null) {
		...
		case "setShaders":
			...
			break;
		case "begin":case "clear":case "createConstantLocation":case "createTextureUnit":case "drawIndexedVertices":case "end":case "setIndexBuffer":case "setMatrix3":case "setPipeline":case "setTexture":case "setVertexBuffer":case "updateIndexBuffer":case "updateVertexBuffer":
