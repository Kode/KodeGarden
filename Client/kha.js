...
WorkerKha.prototype = {
	...
	,onMessage: function(message) {
		...
		case "createIndexBuffer":
			...
			var k = data.id;
			var v = new kha_graphics4_IndexBuffer(data.size,kha_graphics4_Usage.StaticUsage);
			this1.set(k,v);
			break;
		...
		case "createVertexBuffer":
			...
			var k2 = data.id;
			var v2 = new kha_graphics4_VertexBuffer(data.size,structure1,kha_graphics4_Usage.StaticUsage);
			this3.set(k2,v2);
			break;
		case "endFrame":
